...
Java_com_mentra_mentra_lc3_L3cCpp_initEncoder(JNIEnv *env, jclass clazz) {
    int dtUs = 10000;
    int srHz = 16000;
...
Java_com_mentra_mentra_lc3_L3cCpp_freeEncoder(JNIEnv *env, jclass clazz, jlong encPtr) {
    void* encMem = reinterpret_cast<void*>(encPtr);
    free(encMem);
}

extern "C" JNIEXPORT jlong JNICALL
Java_com_mentra_mentra_lc3_L3cCpp_initDecoder(JNIEnv *env, jclass clazz) {
    int dtUs = 10000;
    int srHz = 16000;
...
extern "C" JNIEXPORT void JNICALL
Java_com_mentra_mentra_lc3_L3cCpp_freeDecoder(JNIEnv *env, jclass clazz, jlong decPtr) {
...
Java_com_mentra_mentra_lc3_L3cCpp_encodeLC3(JNIEnv *env, jclass clazz, jlong encPtr, jbyteArray pcmData, jint frameSize) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_mentra_mentra_lc3_L3cCpp_decodeLC3(JNIEnv *env, jclass clazz, jlong decPtr, jbyteArray lc3Data, jint frameSize) {
