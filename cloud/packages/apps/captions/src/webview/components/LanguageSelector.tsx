        ...
        <div className="flex flex-col h-full bg-zinc-100">
            ...
            <div className="px-6 py-4 flex flex-col gap-4 shrink-0">
                <div className="flex flex-wrap gap-3">
                    ...
                    <div className="px-4 py-2 bg-[#6DAEA6] rounded-full flex items-center gap-2 shadow-sm">
                    ...
                    {tempHints.map((code) => (
                        <div
                            key={code}
                            className="px-4 py-2 bg-[#6DAEA6] rounded-full flex items-center gap-2 shadow-sm">
                            ...
                            <button
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col items-start">
                                        <span className="text-base font-bold text-gray-900 font-['Red_Hat_Display']">
                                            {lang.name}
                                        </span>
                                        {lang.nativeName && (
                                            <span className="text-sm text-gray-500 font-['Red_Hat_Display']">
                                                {lang.nativeName}
                                            </span>
                                        )}
                                    </div>
