      ...
      {isListening && (
        <div className="px-2 py-1.5 bg-destructive rounded-2xl backdrop-blur-lg flex justify-center items-center gap-2.5">
          ...
          <div className="w-3 flex justify-between items-center gap-0.5">
            ...
            <div className="w-0.5 h-3.5 bg-primary-foreground rounded-full animate-pulse delay-75" />
            <div className="w-0.5 h-2 bg-primary-foreground rounded-full animate-pulse delay-150" />
            <div className="w-0.5 h-2.5 bg-primary-foreground rounded-full animate-pulse delay-200" />
            <div className="w-0.5 h-2 bg-primary-foreground rounded-full animate-pulse delay-300" />
          </div>
