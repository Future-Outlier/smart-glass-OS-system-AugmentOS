...
import {AppServer, AppSession, ViewType, TranscriptionData} from "@mentra/sdk"
...
export class LiveCaptionsApp extends AppServer {
  ...
  protected async onSession(session: AppSession, sessionId: string, userId: string): Promise<void> {
    ...
    this.inactivityTimers.set(sessionId, {
      timer: null,
  ...
  private async applySettings(session: AppSession, sessionId: string, userId: string): Promise<void> {
    try {
      ...
      console.log(
        `Applied settings for user ${userId}: language=${locale}, lineWidth=${lineWidth}, numberOfLines=${numberOfLines}, isChineseLanguage=${isChineseLanguage}`,
      )
  ...
  protected async onStop(sessionId: string, userId: string, reason: string): Promise<void> {
    ...
    userActiveLanguages.delete(userId)
   ...
   */
  private handleTranscription(session: AppSession, sessionId: string, userId: string, transcriptionData: any): void {
   ...
   */
  private showTranscriptsToUser(session: AppSession, transcript: string, isFinal: boolean): void {
