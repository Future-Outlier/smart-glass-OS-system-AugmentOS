...
const (
	...
	LiveKitBridge_RegisterUdpUser_FullMethodName   = "/mentra.livekit.bridge.LiveKitBridge/RegisterUdpUser"
	LiveKitBridge_UnregisterUdpUser_FullMethodName = "/mentra.livekit.bridge.LiveKitBridge/UnregisterUdpUser"
	LiveKitBridge_SubscribeUdpPings_FullMethodName = "/mentra.livekit.bridge.LiveKitBridge/SubscribeUdpPings"
)
...
type LiveKitBridgeClient interface {
	...
	// Registers a user's hash for UDP audio packet routing
	RegisterUdpUser(ctx context.Context, in *RegisterUdpUserRequest, opts ...grpc.CallOption) (*RegisterUdpUserResponse, error)
	UnregisterUdpUser(ctx context.Context, in *UnregisterUdpUserRequest, opts ...grpc.CallOption) (*UnregisterUdpUserResponse, error)
	// Subscribe to UDP ping notifications (server-streaming)
	// When a UDP ping is received from a mobile client, this stream notifies TypeScript
	SubscribeUdpPings(ctx context.Context, in *SubscribeUdpPingsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[UdpPingNotification], error)
}
...
func (c *liveKitBridgeClient) RegisterUdpUser(ctx context.Context, in *RegisterUdpUserRequest, opts ...grpc.CallOption) (*RegisterUdpUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterUdpUserResponse)
	err := c.cc.Invoke(ctx, LiveKitBridge_RegisterUdpUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveKitBridgeClient) UnregisterUdpUser(ctx context.Context, in *UnregisterUdpUserRequest, opts ...grpc.CallOption) (*UnregisterUdpUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UnregisterUdpUserResponse)
	err := c.cc.Invoke(ctx, LiveKitBridge_UnregisterUdpUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveKitBridgeClient) SubscribeUdpPings(ctx context.Context, in *SubscribeUdpPingsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[UdpPingNotification], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LiveKitBridge_ServiceDesc.Streams[2], LiveKitBridge_SubscribeUdpPings_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeUdpPingsRequest, UdpPingNotification]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LiveKitBridge_SubscribeUdpPingsClient = grpc.ServerStreamingClient[UdpPingNotification]
...
type LiveKitBridgeServer interface {
	...
	// UDP audio registration
	// Registers a user's hash for UDP audio packet routing
	RegisterUdpUser(context.Context, *RegisterUdpUserRequest) (*RegisterUdpUserResponse, error)
	UnregisterUdpUser(context.Context, *UnregisterUdpUserRequest) (*UnregisterUdpUserResponse, error)
	// Subscribe to UDP ping notifications (server-streaming)
	// When a UDP ping is received from a mobile client, this stream notifies TypeScript
	SubscribeUdpPings(*SubscribeUdpPingsRequest, grpc.ServerStreamingServer[UdpPingNotification]) error
...
func (UnimplementedLiveKitBridgeServer) RegisterUdpUser(context.Context, *RegisterUdpUserRequest) (*RegisterUdpUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterUdpUser not implemented")
}
func (UnimplementedLiveKitBridgeServer) UnregisterUdpUser(context.Context, *UnregisterUdpUserRequest) (*UnregisterUdpUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnregisterUdpUser not implemented")
}
func (UnimplementedLiveKitBridgeServer) SubscribeUdpPings(*SubscribeUdpPingsRequest, grpc.ServerStreamingServer[UdpPingNotification]) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeUdpPings not implemented")
}
...
func _LiveKitBridge_RegisterUdpUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterUdpUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveKitBridgeServer).RegisterUdpUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveKitBridge_RegisterUdpUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveKitBridgeServer).RegisterUdpUser(ctx, req.(*RegisterUdpUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _LiveKitBridge_UnregisterUdpUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnregisterUdpUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveKitBridgeServer).UnregisterUdpUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveKitBridge_UnregisterUdpUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveKitBridgeServer).UnregisterUdpUser(ctx, req.(*UnregisterUdpUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _LiveKitBridge_SubscribeUdpPings_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SubscribeUdpPingsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LiveKitBridgeServer).SubscribeUdpPings(m, &grpc.GenericServerStream[SubscribeUdpPingsRequest, UdpPingNotification]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LiveKitBridge_SubscribeUdpPingsServer = grpc.ServerStreamingServer[UdpPingNotification]
...
var LiveKitBridge_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegisterUdpUser",
			Handler:    _LiveKitBridge_RegisterUdpUser_Handler,
		},
		{
			MethodName: "UnregisterUdpUser",
			Handler:    _LiveKitBridge_UnregisterUdpUser_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SubscribeUdpPings",
			Handler:       _LiveKitBridge_SubscribeUdpPings_Handler,
			ServerStreams: true,
		},
	},
