...
const Header: React.FC<HeaderProps> = ({ onSearch, onSearchClear }) => {
  ...
  return (
    <header
      className="hidden sm:block sticky top-0 z-10 transition-all duration-300"
      style={{
        background:
          theme === "light"
            ? "#ffffff"
            : "linear-gradient(to bottom, #13141a, #0a0a0f)",
    ...
    >
      <div className=" mx-auto px py-2 pr-15 pl-15">
        ...
        <div className="flex relative flex-row lg:flex-row lg:items-center lg:justify-between gap-4 min-h-[60px]  items-center">
          ...
          <>
            <div className="flex flex-row relative lg:flex-row lg:items-center lg:justify-between gap-4 min-h-[60px]">
              ...
              <AnimatePresence>
                {(!searchMode || windowWidth < 640 || windowWidth > 1330) && (
                  ...
                  >
                    <Link
                      to="/"
                      className="flex items-center gap-2 sm:gap-4 select-none hover:opacity-80 transition-opacity flex-1 "
                    >
                      <img
                ...
                {!searchMode && (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() =>
                        window.open("https://mentraglass.com/", "_blank")
                      }
                    >
                      Glasses
                    </button>
                    ...
                    <button
                      ...
                      style={{ color: "var(--text-primary)" }}
                      onClick={() =>
                        window.open("https://mentraglass.com/contact", "_blank")
                      }
                    >
                      Support
                    </button>
