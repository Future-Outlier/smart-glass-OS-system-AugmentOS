...
- **Patterns**: `blink()`, `pulse()`, `solid()` for common behaviors
- **Purpose-specific**: `userFeedback()` for user-facing notifications
...
// Processing status
await session.led.pulse('orange', 2000);
...
- 🎤 **Voice Integration**: [Events](/events) - Create voice-activated LED experiences
- 🔐 **Permissions**: [Permissions](/permissions) - LED-related permissions
