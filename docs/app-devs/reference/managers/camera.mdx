...
**Example:** A 1440×1088 pixel photo captured at medium size (typical: ~280KB):
- `"none"`: 1440×1088, full quality → **~280KB**
- `"medium"`: 1080×816, 80% quality → **~140KB** (50% smaller)
- `"heavy"`: 720×544, 60% quality → **~70KB** (75% smaller)

For large size photos (3264×2448, typical: ~800KB):
- `"none"`: 3264×2448, full quality → **~800KB**
- `"medium"`: 2448×1836, 80% quality → **~400KB**
- `"heavy"`: 1632×1224, 60% quality → **~200KB**
