...
<CardGroup cols={2}>
  <Card title="Display & UI" icon="display" href="/app-devs/core-concepts/app-session/display-and-ui">
  ...
  <Card title="API Reference" icon="book" href="/reference/app-session">
