...
<CardGroup cols={2}>
  <Card title="Text-to-Speech" icon="comment" href="/app-devs/core-concepts/audio/text-to-speech">
    Respond with voice synthesis
  </Card>
  <Card title="Audio Chunks" icon="waveform" href="/app-devs/core-concepts/audio/audio-chunks">
    Process raw audio data
  </Card>
  <Card title="Event Manager" icon="book" href="/reference/managers/event-manager">
