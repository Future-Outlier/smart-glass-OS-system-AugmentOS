...
MentraOS is how you write smart glasses apps. In this Quickstart, we go from zero to fully functioning app in less than 15 minutes. You just need a phone and some basic TypeScript knowledge to get started, you can get started **without smart glasses**, or use one of [these smart glasses](https://mentraglass.com/os#glasses/).
...
4. Set up your environment variables:
   * Create a `.env` file in the root directory by copying the example:
     ...
     cp .env.example .env
     ```
   * Edit the `.env` file with your own app's details:
5. Run your app:
   ```bash
   bun run dev
   ```
