   ...
   <Tabs>
     <Tab title="Camera Glasses">
       ...
       **Repository:** [MentraOS-Camera-Example-App](https://github.com/Mentra-Community/MentraOS-Camera-Example-App)
       ...
       ```bash
       git clone https://github.com/Mentra-Community/MentraOS-Camera-Example-App.git
       ```
     </Tab>
     <Tab title="Display Glasses">
       ...
       **Repository:** [MentraOS-Display-Example-App](https://github.com/Mentra-Community/MentraOS-Display-Example-App)
       ...
       Clone your new repo locally:
       ```bash
       git clone https://github.com/Mentra-Community/MentraOS-Display-Example-App.git
       ```
     </Tab>
   </Tabs>
